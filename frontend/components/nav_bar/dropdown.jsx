        ...
        return (
            <div className="dropdown">
                ...
                <div className="icon-button" >
                        <FontAwesomeIcon icon={faUserCircle} className="logged-in-icon" onClick={this.handleClick} />
                </div>
                </div>
                            ...
                            <ul className="dd-option-list">
                               <li onClick={logout} className="dd-option">
                                   <div className="list-sign-out">
                                        <FontAwesomeIcon icon={faSignOutAlt} className="signout-icon" /><span className="so-text">Sign out</span>
                                   </div>
                                   </li> 
                            </ul>
                        </div>
