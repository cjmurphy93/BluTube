  ...
  render() {
    ...
    const first_nameError = errors.first_name ? (
      <div className="error-msg">
        <FontAwesomeIcon icon={faExclamationCircle} className="ex-circle" />
    ...
    const revealIcon = this.state.revealed ? (
      <FontAwesomeIcon
        icon={faEye}
          ...
          <form className="login-form">
            ...
            <section className="input-section">
              <section className="name">
                <div className="fn">
                  <input
                    className={`email-text name-text ${frb}`}
                    type="text"
                ...
                <div className="ln">
                  <input
                    className={`email-text name-text ${lrb}`}
                    type="text"
              ...
              <section className="signup-password">
                <section className="signup-password-inputs">
                  <section className="signup-pw-main">
                    <input
                      className={`email-text m-password ${prb}`}
                      type={`${revealType}`}
                  ...
                  <section className="signup-pw-match">
                    <input
                      className={`email-text m-password ${mrb1} ${mrb2}`}
                      type={`${revealType}`}
                ...
                <span className="passwordInstructions">
